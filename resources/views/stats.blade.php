...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm">
            <p class="blockquote">De reden waarom toegankelijkheid zo belangrijk is is omdat er zijn veel meer mensen dan we denken die beperkingen hebben</p>
            ...
            <p class="blockquote">Dit betekent dat als je site niet toegankelijk is dan kan <strong>1/3 van je klanten</strong> jouw producten niet kopen.</p>
            <p class="blockquote">Dit veroorzaakt minder inkomsten en groei voor je webshop</p>
            <p class="blockquote">Maar met deze digitale handboek kan je uitdaging doen die je tips kan geven om <strong>jouw</strong> website te verbeteren.</p>
        </div>
        <div class="col-sm">
