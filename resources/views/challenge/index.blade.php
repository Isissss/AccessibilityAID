...
@section('content')
    ...
    <div class="col-md-8 m-auto mt-4">
        ...
        <div class="d-flex justify-content-end">
            <a href="{{route('download-rapport')}}" class="btn btn-success mb-2 @if(!(auth()->user()->completed_challenges->count() >= 1)) disabled @endif">@if(!(auth()->user()->completed_challenges->count() >= 1)) Je hebt nog geen opdrachten voltooid @else Vraag rapport op @endif</a>
        </div>
        <div class="card">
