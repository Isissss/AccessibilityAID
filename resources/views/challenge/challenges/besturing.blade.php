...
@section('content')
    <header class="p-3 w-100 bg-primary d-flex flex-row align-items-center justify-content-between">
        <a href="" class="text-decoration-none"><h1>Webshop</h1></a>
        <div class="col-md-5 d-flex align-items-center gap-2">
            <label for="search" class="fw-bold">Zoeken:</label>
            <input id="search" type="text" class="form-control">
            <button class="btn btn-primary black-65">Zoeken</button>
        </div>
    ...
    <nav class="d-flex flex-row bg-info p-1 px-3 gap-4">
        ...
        <a href="{{route('completed-challenge.show', $challenge)}}" class="text-decoration-none text-black" style="pointer-events: none"><h4 class="mt-2">Categorie 5</h4></a>
