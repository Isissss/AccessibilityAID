                ...
                <div class="card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('reviews.destroy',$review)); ?>" method="Post">
                            <a class="btn btn-primary" href="<?php echo e(route('reviews.show',$review)); ?>">show</a>
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AccessibilityAID\resources\views/reviews/index.blade.php ENDPATH**/ ?>