...
<?php $__env->startSection('content'); ?>
    <header class="p-3 w-100 bg-primary d-flex flex-row align-items-center justify-content-between black-50">
        ...
        <div class="col-md-5 d-flex align-items-center gap-2">
            ...
            <button class="btn btn-primary black-65 border-black-50">Zoeken</button>
        </div>
    ...
    <nav class="d-flex flex-row bg-info p-1 px-3 gap-4 black-65">
    ...
    <main class="d-flex m-5 gap-5">
        <filters class="col-md-2 border d-flex flex-column p-3 gap-4 my-auto black-65">
            <h1>Filters</h1>
            <div class="form-group">
                <h2><label for="prijsRange" class="form-label">Prijs</label></h2>
                <input type="range" class="form-range custom-range" id="prijsRange">
            </div>
            <div class="form-group">
                <h2><label for="lengteRange" class="form-label">Lengte</label></h2>
                <input type="range" class="form-range custom-range" id="lengteRange">
            </div>
                <a href="<?php echo e(route('completed-challenge.show', $challenge)); ?>" class="text-decoration-none label-text">
                    <div class="form-group">
            ...
            <div class="col-md-2">
                <div class="card">
                    <img
                        ...
                        alt="" class="card-img top grayscale">
                    <div class="card-body black-65">
                        <h3>Product 1</h3>
...
<?php echo $__env->make('layouts.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\AccessibilityAID\resources\views/challenge/show.blade.php ENDPATH**/ ?>